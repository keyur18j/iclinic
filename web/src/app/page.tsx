    ...
    <div className="mx-auto max-w-6xl px-4 py-12 space-y-16">
      ...
      <section className="grid gap-10 md:grid-cols-2 md:items-center">
        <div className="space-y-6">
          <div className="inline-block rounded-full bg-sky-500/10 px-3 py-1 text-xs font-semibold text-sky-600 dark:text-sky-400">
            AI Front-Desk for Clinics
          </div>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            AI Front-Desk for Clinics
          </h1>
          <p className="text-xl text-sky-600 dark:text-sky-400 font-medium">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 p-6 space-y-4">
          ...
          <div className="aspect-video rounded-lg bg-gradient-to-br from-sky-100 to-slate-100 dark:from-slate-800 dark:to-slate-900 flex items-center justify-center">
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div
              key={idx}
              className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 p-6 space-y-2"
            >
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-4">
          {[
            ...
            <div
              key={idx}
              className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 p-6 space-y-2 text-center"
            >
              <div className="w-10 h-10 rounded-full bg-sky-500 text-background flex items-center justify-center font-bold mx-auto">
                {item.step}
              </div>
      ...
      <section className="flex flex-wrap gap-3 justify-center">
        {[
          ...
          <span
            key={idx}
            className="px-4 py-2 rounded-full bg-slate-100 dark:bg-slate-900 text-xs font-medium text-slate-700 dark:text-slate-300"
          >
            {badge}
          </span>
        ))}
      ...
      {/* Pricing Teaser */}
      <section className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 p-8 space-y-4 text-center max-w-2xl mx-auto">
        ...
        <Link
          href="/pricing"
          className="inline-block bg-sky-500 text-background rounded-lg px-6 py-3 text-sm font-semibold hover:bg-sky-600 transition"
        >
          View full pricing
        </Link>
      </section>
